...
public class PreferenceApiDto {
    @Id
    @Column(length = 100)
    private String userId;

    // The length of VARCHAR column is set 20
    @Column(length = 20)
    ...
    public String toString() {
        return "PreferenceDto [userId=" + userId + ", marsApiRoverData=" + marsApiRoverData + ", marsSol=" + marsSol
